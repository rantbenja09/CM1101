...
def filter_words(words, skip_words):
    ...
    """
    filtered_list = [x for x in words if x not in skip_words]
...
def normalise_input(user_input):
    ...
    cleaned_input =remove_punct(user_input).strip().lower().split()
    final_input = filter_words(cleaned_input, skip_words)
    return final_input

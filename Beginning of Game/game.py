...
def normalise_input(user_input):
    ...
    'help'
    """
    nolt  = user_input.strip()#remove leading and trailing 
    ...
    no_caps = no_punc.lower()

    return(no_caps.strip())
...
def menu(exits):
    ...
    while True:
        print_menu(exits)
        direction = input()
        direction = remove_spaces(direction)
        direction = remove_punct(direction)
